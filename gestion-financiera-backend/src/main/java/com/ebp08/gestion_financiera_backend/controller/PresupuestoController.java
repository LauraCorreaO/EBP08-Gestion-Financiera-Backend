...
public class PresupuestoController {
    ...
    public ResponseEntity<Presupuesto>crearPresupuestoGlobal(@Valid@RequestBody Presupuesto presupuesto) {
    ...
    public ResponseEntity<Presupuesto>crearPresupuestoCategoria(@Valid@RequestBody Presupuesto presupuesto) {
